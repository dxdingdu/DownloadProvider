...
public final class Downloads implements BaseColumns {
     ...
     */
    public static final String AUTHORITY = "com.hycode.qrcodeapp.downloads";
     ...
     * @hide
     */
    public static final String PERMISSION_ACCESS = "com.hycode.qrcodeapp.permission.ACCESS_DOWNLOAD_MANAGER";
     ...
     * @hide
     */
    public static final String PERMISSION_ACCESS_ADVANCED = "com.hycode.qrcodeapp.permission.ACCESS_DOWNLOAD_MANAGER_ADVANCED";

    /**
     * The permission to access the all the downloads in the manager.
     */
    public static final String PERMISSION_ACCESS_ALL = "com.hycode.qrcodeapp.permission.ACCESS_ALL_DOWNLOADS";
     ...
     * @hide
     */
    public static final String PERMISSION_SEND_INTENTS = "com.hycode.qrcodeapp.permission.SEND_DOWNLOAD_COMPLETED_INTENTS";

    /**
     * The permission to download files without any system notification being
     * shown.
     */
    public static final String PERMISSION_NO_NOTIFICATION = "com.hycode.qrcodeapp.permission.DOWNLOAD_WITHOUT_NOTIFICATION";
